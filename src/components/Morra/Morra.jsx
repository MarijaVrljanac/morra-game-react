...
import "./Morra.css";
import moraPicture from "./assets/morra-game.jpg";

const Morra = () => {
  const [numberOfFingersShownPlayer1, setNumberOfFingersShownPlayer1] =
    useState(null);
  const [numberOfFingersGuessedPlayer1, setNumberOfFingersGuessedPlayer1] =
    useState(null);
  const [numberOfFingersShownPlayer2, setNumberOfFingersShownPlayer2] =
    useState(null);
  const [numberOfFingersGuessedPlayer2, setNumberOfFingersGuessedPlayer2] =
    useState(null);
  ...
  const calculateResult = () => {
    if (
      ...
      numberOfFingersShownPlayer2 &&
      numberOfFingersGuessedPlayer2
    ) {
      if (
        numberOfFingersShownPlayer1 + numberOfFingersGuessedPlayer2 ==
        numberOfFingersGuessedPlayer1
      ) {
  ...
  return (
    <div className="wrapper">
      <div>
        ...
        <hr />
        <img src={moraPicture} alt="morra-game" />
        <hr />
        <p style={{ color: "palevioletred" }}>
          ✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦✦
        </p>
